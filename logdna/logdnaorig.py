...
# new here
        self.internalLogger.error('Error sending logs %s', exception)
        self.internalLogger.info('last msg {}'.format(self.buf))
...
#            self.internalLogger.debug('Error sending logs %s', exception)
    ...
    def send_request(self):
        ...
        except urllib3.execeptions.HTTPError as he:
            print('urllib3  exception {}'.format(he))
            self.handle_exception(he)
        except urllib3.execeptions.HTTPWarning as hw:
            print('urllib3 warning {}'.format(hw))
            self.handle_exception(hw)
